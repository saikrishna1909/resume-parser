...
#     Ensure the response is a **valid JSON object** without any extra text, explanation, or comments.
#     """
...
#             return {"error": "Gemini API response is not a valid JSON.", "raw_response": raw_response}
...
# test_resume_path = "C:/Users/SAI KRISHNA/Downloads/Engineering_Industrial_Tech_Resume.pdf"
...
#     structured_data = extract_resume_info(extracted_text)

#     # ✅ Print structured data (for debugging)
#     print("\n✅ Gemini API Response:", json.dumps(structured_data, indent=2))
import os
import json
import io
import pdfplumber
